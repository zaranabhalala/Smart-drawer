<!-- import Person and ViewPerson class to use methods -->
...
<html lang="en">
    ...
    <body onload=f()>
        ...
        <%-- Use viewPerson class and create object of that class as 'obj' --%>
        <jsp:useBean id="obj" class= "View.ViewPerson"/> 

        <%

            //call getallPerson of viewPerson class and store its return value in List as list
            ArrayList<Person> list = obj.getallPerson();
                        ...
                        <div class="col-lg-12">
                            <div class="page-title">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2>Person Table <u><i><small><a href="person.jsp">Add New<a></small></i></u></h2>
                                                                        ...
                                                                        <table id="datatable-buttons" class="table table-striped table-bordered">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td><%= list.get(i).getAdhar_id()%></td>
                                                                                    <td><%= list.get(i).getContact_no()%></td>
                                                                                    <td><textarea class="table table-striped table-bordered" readonly><%= list.get(i).getAddress()%></textarea></td>

                                                                                    <td> <a href=<%=  "http://localhost:8082/messanger/webapi/persons/delete/" + list.get(i).getAdhar_id() + ""%>> Delete</b></a>						  
                                                                                </tr>
                                                                                <%  id++;
                                                    }%>
