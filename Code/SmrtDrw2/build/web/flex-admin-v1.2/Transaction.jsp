<!-- import Transaction and ViewTransaction class to use methods -->
<%@page import="Model.Transaction"%>
<%@page import="View.ViewTransaction"%>
...
<html lang="en">
    ...
    <body onload=f()>
        ...
        <%-- Use viewTransaction class and create object of that class as 'obj' --%>
        <jsp:useBean id="obj" class= "View.ViewTransaction"/> 

        <%

            //call getallTransaction of viewTransaction class and store its return value in ArrayList as list
            ArrayList<Transaction> list = obj.getallTransaction();
                        ...
                        <div class="col-lg-12">
                            <div class="page-title">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2>Transaction Table <small></small></h2>
                                        ...
                                        <div class="x_content">
                                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><%= list.get(i).getTag_serial_no()%></td>
                                                    <td><%= list.get(i).getItem_ID()%></td>
                                                    <td><%= list.get(i).getItem_Name()%></td>
                                                    <td><%= list.get(i).getDrawerid()%></td>
                                                    <td><%= list.get(i).getAddharId()%></td>
