...
public class ViewDrawer {
    ...
    //method shows details of all items in drawer according to drawer_id
    public ArrayList<Item> getAllDrawerItems(String drawer_id) {
        ...
        //return created list
        session.setAttribute("Tabel", list);
        return list;
    }
